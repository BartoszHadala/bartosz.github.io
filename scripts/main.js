...
document.addEventListener("DOMContentLoaded", () => {
  ...
  // Obsługa kliknięcia przycisków About Me
  ...
  // Domyślnie ukryj wszystkie sekcje About Me
  ...
  // Obsługa kliknięcia flag językowych (bezpiecznie)
  const langPL = document.getElementById("lang-pl");
  const langEN = document.getElementById("lang-en");
  if (langPL) langPL.addEventListener("click", () => setLanguage("pl"));
